...
<div class="features">
  <div class="wrapper">
      <div class="ftItems">
          <div class="ftItem">
              <div class="ftItem__img"><img class="ftItem__icon" src="img/ftr-1.png" alt="res"></div>
          ...
          <div class="ftItem">
              <div class="ftItem__img"><img class="ftItem__icon" src="img/ftr-2.png" alt=""></div>
              <div class="ftItem__box">
          ...
          <div class="ftItem">
              <div class="ftItem__img"><img class="ftItem__icon" src="img/ftr-3.png" alt=""></div>
              <div class="ftItem__box">
          ...
          <div class="ftItem">
              <div class="ftItem__img"><img class="ftItem__icon" src="img/ftr-4.png" alt=""></div>
              <div class="ftItem__box">
          ...
          <div class="ftItem">
              <div class="ftItem__img"><img class="ftItem__icon" src="img/ftr-5.png" alt=""></div>
              <div class="ftItem__box">
          ...
          <div class="ftItem">
              <div class="ftItem__img"><img class="ftItem__icon" src="img/ftr-6.png" alt=""></div>
              <div class="ftItem__box">
...
<section class="discover">
  <div class="wrapper">
      <div class="disItems">
          <div class="disItemL"><img src="img/adv-4.png" alt="labore" class="disItemL__img"></div>
          <div class="disItemR">
              ...
              <div class="disItemR__box">
                  <div class="disItemR__list">
                      <div class="disItemR__imgCircle"><img src="img/adv-5.png" alt="adv" class="disItemR__icon"></div>
                      <span class="disItemR__listText">Lorem ipsum dolor sit amet </span></div>
                  <div class="disItemR__list">
                      <div class="disItemR__imgCircle"><img src="img/adv-6.png" alt="adv" class="disItemR__icon"></div>
                      <span class="disItemR__listText">Conse ctetur adipisicing</span></div>
                  <div class="disItemR__list">
                      <div class="disItemR__imgCircle"><img src="img/adv-7.png" alt="adv" class="disItemR__icon"></div>
                      <span class="disItemR__listText">Elit sed do eiusmod tempor</span></div>
                  <div class="disItemR__list">
                      <div class="disItemR__imgCircle"><img src="img/adv-8.png" alt="adv" class="disItemR__icon"></div>
  ...
  <div class="advItems">
      <div class="advItem advItem-left">
          <div class="advItem__box">
              <img src="img/adv-1.png" alt="" class="advItem__icon advItem__icon-small">
      ...
      <div class="advItem advItem-middle">
          <div class="advItem__box">
              <img src="img/adv-2.png" alt="" class="advItem__icon">
      ...
      <div class="advItem advItem-right">
          <div class="advItem__box">
              <img src="img/adv-3.png" alt="" class="advItem__icon">
...
<section class="blog">
  <div class="wrapper">
      ...
      <div class="blogItems">
          <div class="blogItem">
              <img src="img/blog-1.jpg" alt="" class="blogItem__img">
          ...
          <div class="blogItem">
              <img src="img/blog-2.jpg" alt="" class="blogItem__img">
              <div class="blogItem__title">Elit sed do eiusmod tempo</div>
              <div class="blogItem__text">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod
                  tempor incid idunt ut labor.
              </div>
          ...
          <div class="blogItem">
              <img src="img/blog-3.jpg" alt="" class="blogItem__img">
              <div class="blogItem__title">Elit sed do eiusmod tempo</div>
              <div class="blogItem__text">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod
                  tempor incid idunt ut labor.
              </div>
...
<div class="stats">
  <div class="wrapper">
      <div class="statItems">
          <div class="statItem">
              <div class="statItem__icon"><img src="img/stat-icon-1.png" alt=""></div>
              <div class="statItem__number">258</div>
              <div class="statItem__text">Elit sed do eiusmod tempo</div>
          </div>
          <div class="statItem">
              <div class="statItem__icon"><img src="img/stat-icon-2.png" alt=""></div>
              <div class="statItem__number">58</div>
              <div class="statItem__text">Elit sed do eiusmod tempo</div>
          </div>
          <div class="statItem">
              <div class="statItem__icon"><img src="img/stat-icon-3.png" alt=""></div>
              <div class="statItem__number">1,897</div>
              <div class="statItem__text">Elit sed do eiusmod tempo</div>
          </div>
          <div class="statItem">
              <div class="statItem__icon"><img src="img/stat-icon-4.png" alt=""></div>
...
<div class="botSlider">
  <div class="sliderBot">
      <div class="slider__team">
          <div class="sliderBot__img"><img src="img/tom.png" alt="tom" class="sliderBot__photo"></div>
